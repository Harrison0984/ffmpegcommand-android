...
public class FFmpegExecuter {
    ...
    private OnEndProcessListener mOnEndProcessLineListener;
    ...
    public void executeCommand() throws IOException {
        ...
        if (mOnEndProcessLineListener != null) {
            mOnEndProcessLineListener.onEndProcess();
        }
    ...
    public void setOnEndProcessListener(OnEndProcessListener pOnEndProcessListener) {
        mOnEndProcessLineListener = pOnEndProcessListener;
    }
    ...
    public interface OnEndProcessListener {
